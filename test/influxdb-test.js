...
describe('influxdb', function() {
  ...
  it('should correctly serialize a meter', function(done){
    ...
    expect(reporter._influx.points[0]).to.have.string('m15_rate=');
    expect(reporter._influx.points[0]).to.have.string('m5_rate=');
    expect(reporter._influx.points[0]).to.have.string('m1_rate=');
  ...
  it('should correctly serialize a histogram', function(done){
    ...
    expect(reporter._influx.points[0]).to.have.string('count=2i');
    expect(reporter._influx.points[0]).to.have.string('min=50i');
    expect(reporter._influx.points[0]).to.have.string('max=100i');
    expect(reporter._influx.points[0]).to.have.string('sum=150i');
    expect(reporter._influx.points[0]).to.have.string('mean=75');
    ...
    expect(reporter._influx.points[0]).to.have.string('p75=');
    expect(reporter._influx.points[0]).to.have.string('p95=');
    expect(reporter._influx.points[0]).to.have.string('p99=');
    expect(reporter._influx.points[0]).to.have.string('p999=');
    done();
  });
