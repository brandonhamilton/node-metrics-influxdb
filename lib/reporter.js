 ...
 */
Reporter.prototype.start = function(scheduleInterval, useBuffer = false) {
...
Reporter.prototype.report = function(useBuffer = true) {
  ...
  if (this._influx.points.length > this.bufferSize && useBuffer) {
    this._influx.write();
  }
}
